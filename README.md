...
get the app created:
    ...
    $ heroku apps:create castellan
    Creating castellan... done, stack is cedar
    http://castellan.herokuapp.com/ | git@heroku.com:castellan.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://castellan.herokuapp.com deployed to Heroku

    To git@heroku.com:castellan.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://castellan.herokuapp.com
    ["Hello" :from Heroku]
...
Then you can launch the REPL:
    ...
    $ lein repl :connect http://$REPL_USER:$REPL_PASSWORD@castellan.herokuapp.com/repl
